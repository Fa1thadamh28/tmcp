package edu.calstate.tmcp.view.util;
...
public class RSExcelFormatHandler extends FormatHandler {
    ...
    private void prepareExcelWorkbook() {
        ...
        xlsColumnHeaderStyle.setAlignment(HorizontalAlignment.CENTER);
        // xlsColumnHeaderStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
        xlsColumnHeaderStyle.setVerticalAlignment(VerticalAlignment.CENTER);
        ...
        xlsColumnHeaderStyle.setFillPattern(FillPatternType.SOLID_FOREGROUND);
        ...
        // xlsTitleStyle.setAlignment(HorizontalAlignment.RIGHT);
        xlsTitleStyle.setAlignment(HorizontalAlignment.LEFT);
        // xlsTitleStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
        xlsTitleStyle.setVerticalAlignment(VerticalAlignment.CENTER);
